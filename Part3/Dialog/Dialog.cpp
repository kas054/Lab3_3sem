...
#include <iostream>
namespace Menu {
    void start(Prog3::Vector3 &vector)
    {
        int rc;
        ...
        int (*fptr[])(Prog3::Vector3 &vector) = { nullptr, D_AddElement, D_Print,  D_Add_Sub,  D_InputParameters, D_Scalar, D_Copy, D_Norm };
    ...
    int D_AddElement(Prog3::Vector3 &vector){
        int count = 0, element;
    ...
    int D_InputParameters(Vector3 &vector)
    {
        ...
        vector.inputParameters(size, numbers);
        D_Print(vector);
        return 1;
    }
